...
{/* cards */}
        ...
        <div>  <span> <IconButton><a href="/">Orange 1</a></IconButton> </span> </div>  
          </div>

          <div className="card">
            <img src={require("../images/card-pic2.jpg")}></img> 
           <span> <IconButton><a href="/">Orange2</a></IconButton> </span> 
          </div>

          <div className="card">
            <img src={require("../images/card-pic3.jpg")}></img> 
           <span> <IconButton><a href="/">Orange3</a></IconButton> </span> 
          </div>

          <div className="card">
            <img src={require("../images/card-pic2.jpg")}></img> 
           <span> <IconButton><a href="/">Orange4</a></IconButton> </span> 
          </div>

          <div className="card">
            <img src={require("../images/card-pic1.jpg")}></img> 
           <span> <IconButton><a href="/">Orange5</a></IconButton> </span> 
          </div>

          <div className="card">
            <img src={require("../images/card-pic3.jpg")}></img> 
           <span> <IconButton><a href="/">Orange6</a></IconButton> </span> 
          </div>

          <div className="card">
            <img src={require("../images/card-pic1.jpg")}></img> 
           <span> <IconButton><a href="/">Orange7</a></IconButton> </span> 
          </div>

          <div className="card">
            <img src={require("../images/card-pic1.jpg")}></img> 
           <span> <IconButton><a href="/">Orange8</a></IconButton> </span> 
          </div>
